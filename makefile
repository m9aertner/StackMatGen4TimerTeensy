...
TARGET_NAME      := Teensy-StackMat-LED
BOARD_ID         := TEENSYLC

MCU              := mkl26z64

LIBS_SHARED_BASE := C:\Users\mgr\Documents\Arduino\libraries
LIBS_SHARED      := 
...
UPL_TYCMD_B      := C:\Hardware\Teensy\TyTools-0.9.2-win64
...
DEFINES     := -D__MKL26Z64__ -DTEENSYDUINO=153 -DARDUINO_TEENSYLC -DARDUINO=10807
DEFINES     += -DF_CPU=48000000 -DUSB_SERIAL -DLAYOUT_GERMAN
